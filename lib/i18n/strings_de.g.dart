...
class TranslationsSettingsDe {
	...
	late final TranslationsSettingsGeneralDe general = TranslationsSettingsGeneralDe._(_root);
}
...
class TranslationsSettingsGeneralDe {
	TranslationsSettingsGeneralDe._(this._root);
	...
	String get title => 'Allgemeine Einstellungen';

	/// de: 'Töne abspielen'
	String get playSound => 'Töne abspielen';

	/// de: 'Ton am Ende jedes Rituals'
	String get playSoundEndOfRitual => 'Ton am Ende jedes Rituals';

	/// de: 'Ton bevor das Ritual endet'
	String get playSoundInRitual => 'Ton bevor das Ritual endet';

	/// de: 'Zeit vor Ende eines Rituals'
	String get timeBeforeRitualEnd => 'Zeit vor Ende eines Rituals';

	/// de: 'Minuten'
	String get minutes => 'Minuten';

	/// de: 'Routine Vorbereitungszeit'
	String get routinePreparationTime => 'Routine Vorbereitungszeit';

	/// de: 'Ritual Vorbereitungszeit'
	String get ritualPreparationTime => 'Ritual Vorbereitungszeit';

	/// de: 'Vorbereitungszeit für das erste Ritual'
	String get firstRitualPreparationTime => 'Vorbereitungszeit für das erste Ritual';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.general.playSound' => 'Töne abspielen',
			'settings.general.playSoundEndOfRitual' => 'Ton am Ende jedes Rituals',
			'settings.general.playSoundInRitual' => 'Ton bevor das Ritual endet',
			'settings.general.timeBeforeRitualEnd' => 'Zeit vor Ende eines Rituals',
			'settings.general.minutes' => 'Minuten',
			'settings.general.routinePreparationTime' => 'Routine Vorbereitungszeit',
			'settings.general.ritualPreparationTime' => 'Ritual Vorbereitungszeit',
			'settings.general.firstRitualPreparationTime' => 'Vorbereitungszeit für das erste Ritual',
